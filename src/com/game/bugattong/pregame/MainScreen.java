...
//				if(GameSettings.levelPlayed[GameSettings.currentLevel-1]){	//may error
...
//				}
			...
			case R.id.main_screen_btn_sound:
				int msg = (GameActivity.isSoundOn == true)? R.drawable.button_sounds_off_state: R.drawable.button_sounds_on_state;
